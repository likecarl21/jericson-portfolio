        ...
        <div className="analysis-timeline">
          ...
          <div className="analysis-step">
            ...
            <div className="analysis-content">
              ...
              <p>
                50% ACOS is over target, so it's tempting to cut it. But "hotel pillow" is a real thing people search when they want that soft, plush feel, so it might still fit the product. Before negating, I'd check if it's converting at all and whether a lower bid brings the ACOS down. Investigate first, then decide.
              </p>
