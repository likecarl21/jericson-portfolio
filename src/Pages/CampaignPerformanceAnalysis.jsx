      ...
      <div className="case-container">
        ...
        <div className="analysis-section">
          ...
          <div className="analysis-list">
            ...
            <div className="analysis-item">
              <strong>CTR is 0.34%, which is a little low.</strong> A low CTR usually isn't about the campaign. It's about what people see before they click, like the main image, price, title, and star rating. So this points me toward checking the listing, not just the ads.
            </div>
